  ...
  return (
    <>
      <div class="flex h-screen box-border">
        <div class="flex justify-between flex-col lg:p-8 md:p-8 sm:p-0 text-white bg-blue-500 md:w-1/2 lg:w-1/2 w-0">
          <div class="my-3 text-2xl font-bold text-left">
            <a href="#">LOGO</a>
          </div>
          ...
          <div class="flex justify-center items-center mt-6 text-sm text-center text-gray-300">
            <div>
              <svg
                width="42"
                height="40"
        ...
        <div class="p-5 bg-gray-100 md:w-1/2 lg:w-1/2 w-full">
          <div class="w-80 mx-auto mt-5">
            <h3 class="text-2xl font-bold text-black">Sign In</h3>
            <p class="text-sm mt-2 text-gray-700">Sign in to your account</p>

            <div class="mt-5 flex justify-between">
              <div class="flex rounded-md px-2.5 py-1 justify-center items-center bg-white cursor-pointer">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                ...
                <p class="text-xs font-Montserrat text-gray-300 ml-3">
                  Sign in with Google
                </p>
              </div>
              <div class="flex rounded-md px-2.5 py-1 justify-center items-center bg-white cursor-pointer">
            ...
            <div class="bg-white mt-5 p-8 rounded-3xl">
              <form action="#" class="flex flex-col space-y-5">
                <div class="flex flex-col space-y-1">
                  ...
                  <input
                    ...
                    id="email"
                    autofocus
                    class="px-4 py-2 transition duration-300 rounded-lg bg-gray-200"
                  />
                </div>
                <div class="flex flex-col space-y-1">
                ...
                <div>
                  ...
                  onClick={()=>{ navigate("/dashboard");}}
                    type="submit"
                    class="w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-blue-500 rounded-xl shadow hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4"
                  >
                    Sign In
                  </button>
